...
// Estimates calories/macros for a plate of food from a photo. Approximate by nature.
...
export default async (req) => {
  ...
  const prompt = `You are a nutrition estimation assistant looking at a photo of a plate/meal of food (not a label — actual food).
